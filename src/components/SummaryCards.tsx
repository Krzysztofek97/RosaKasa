  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
      ...
      <motion.div
        ...
        onDrop={handleDrop}
        className={`bg-slate-900 rounded-2xl p-2.5 px-3.5 text-white shadow-md relative overflow-hidden flex items-center justify-between gap-3 w-full sm:w-auto min-w-[200px] border transition-all duration-300 ${
